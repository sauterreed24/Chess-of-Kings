...
**Testing scopes.** `npm test` currently runs **482 tests across 60 files** (roughly 3-4 minutes on this machine with sequential Vitest execution for stability). The categories are:
