...
const BOOKS: Record<string, OpeningBook> = {
  ...
  voss_exchange: {
    1: [{ san: 'd5', weight: 9 }, { san: 'e6', weight: 3 }, { san: 'd6', weight: 2 }],
    3: [{ san: 'e6', weight: 9 }, { san: 'Nf6', weight: 4 }],
    5: [{ san: 'Nf6', weight: 8 }, { san: 'Be7', weight: 5 }],
    7: [{ san: 'Be7', weight: 8 }, { san: 'O-O', weight: 4 }],
    9: [{ san: 'O-O', weight: 7 }, { san: 'c5', weight: 5 }],
  },
  elara_fork: {
    1: [{ san: 'c5', weight: 9 }, { san: 'e5', weight: 3 }, { san: 'c6', weight: 2 }],
    3: [{ san: 'd6', weight: 9 }, { san: 'Nc6', weight: 4 }],
    5: [{ san: 'Nf6', weight: 8 }, { san: 'Nc6', weight: 5 }],
