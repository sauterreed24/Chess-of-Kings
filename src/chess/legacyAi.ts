/* ─── LEGACY ENGINE (benchmark baseline only) ─────────────────────────────
   The original chess.js-walking alpha-beta search, retained so Crown
   Engine v2 improvements stay measurable (see engine/crownVsLegacy
   .bench.test.ts). Nothing in the app imports this module, so it is
   tree-shaken out of production bundles. Do not extend it; engine work
   happens in src/chess/engine/ and src/chess/ai.ts.
   ────────────────────────────────────────────────────────────────────────── */
