...
describe('AI profile resolver', () => {
  ...
  it('sharpens Rowan as fire and Vega as disciplined pressure', () => {
    ...
    expect(rowan.openingDiscipline).toBeLessThan(0.36)
    ...
    expect(vega.riskAppetite).toBeLessThan(0.5)
    expect(vega.openingDiscipline).toBeGreaterThanOrEqual(0.9)
    ...
    expect(vega.weights.prophylactic).toBeGreaterThanOrEqual(0.8)
    expect(vega.motifBias.pin).toBeGreaterThan(rowan.motifBias.pin)
    expect(vega.motifBias.pin).toBeGreaterThanOrEqual(0.9)
  })
  ...
  it('makes Alexion and apotheosis profiles feel inevitable rather than reckless', () => {
    ...
    expect(strategos.riskAppetite).toBeLessThanOrEqual(0.3)
    expect(strategos.weights.prophylactic).toBeGreaterThanOrEqual(0.95)
    ...
    expect(apex.riskAppetite).toBeLessThan(0.3)
    ...
    expect(counterpart.riskAppetite).toBeLessThanOrEqual(0.3)
