...
export const AI_PROFILES: Record<string, AiProfile> = {
  ...
  advisor_boss: {
    ...
    conversionPersona: 'technical',
    weights: { tactical: 0.78, positional: 0.82, sacrificial: 0.45, prophylactic: 0.82 },
    motifBias: { fork: 0.56, pin: 0.84, skewer: 0.78, kingHunt: 0.54 },
  },
  counterpart_apex: {
    id: 'counterpart_apex',
    ...
    conversionPersona: 'technical',
    weights: { tactical: 0.9, positional: 0.9, sacrificial: 0.52, prophylactic: 0.86 },
    motifBias: { fork: 0.7, pin: 0.9, skewer: 0.9, kingHunt: 0.65 },
  },
  alexion_mentor: {
    id: 'alexion_mentor',
    ...
    blunderRate: 0.11,
    riskAppetite: 0.25,
    tacticalAlertness: 0.52,
    openingDiscipline: 0.75,
    kingSafetyUrgency: 0.76,
    conversionStrictness: 0.55,
    conversionPersona: 'universal',
    weights: { tactical: 0.52, positional: 0.8, sacrificial: 0.2, prophylactic: 0.8 },
    motifBias: { fork: 0.44, pin: 0.68, skewer: 0.52, kingHunt: 0.36 },
  },
  alexion_strategos: {
    ...
    blunderRate: 0.06,
    riskAppetite: 0.4,
    tacticalAlertness: 0.74,
    openingDiscipline: 0.85,
    kingSafetyUrgency: 0.82,
    conversionStrictness: 0.76,
    conversionPersona: 'technical',
    weights: { tactical: 0.66, positional: 0.84, sacrificial: 0.38, prophylactic: 0.86 },
    motifBias: { fork: 0.58, pin: 0.86, skewer: 0.82, kingHunt: 0.5 },
  },
  alexion_apex: {
    id: 'alexion_apex',
