...
export const AI_PROFILES: Record<string, AiProfile> = {
  ...
  counterpart_apex: {
    ...
    blunderRate: 0.012,
    riskAppetite: 0.36,
    tacticalAlertness: 0.93,
    openingDiscipline: 0.98,
    kingSafetyUrgency: 0.97,
    conversionStrictness: 0.99,
    conversionPersona: 'technical',
    weights: { tactical: 0.9, positional: 0.97, sacrificial: 0.42, prophylactic: 0.98 },
    motifBias: { fork: 0.68, pin: 0.98, skewer: 0.97, kingHunt: 0.58 },
  },
  alexion_mentor: {
    id: 'alexion_mentor',
    ...
    openingDiscipline: 0.82,
    kingSafetyUrgency: 0.8,
    conversionStrictness: 0.64,
    conversionPersona: 'universal',
    weights: { tactical: 0.5, positional: 0.85, sacrificial: 0.16, prophylactic: 0.88 },
  ...
  alexion_strategos: {
    ...
    openingDiscipline: 0.91,
    kingSafetyUrgency: 0.88,
    conversionStrictness: 0.87,
    conversionPersona: 'technical',
    weights: { tactical: 0.64, positional: 0.9, sacrificial: 0.3, prophylactic: 0.93 },
    motifBias: { fork: 0.54, pin: 0.91, skewer: 0.88, kingHunt: 0.42 },
  },
  alexion_apex: {
    id: 'alexion_apex',
    ...
    conversionStrictness: 0.99,
    conversionPersona: 'technical',
    weights: { tactical: 0.9, positional: 0.98, sacrificial: 0.42, prophylactic: 0.98 },
    motifBias: { fork: 0.68, pin: 0.99, skewer: 0.98, kingHunt: 0.6 },
  },
  rowan_gambit: {
    id: 'rowan_gambit',
    ...
    openingDiscipline: 0.38,
    kingSafetyUrgency: 0.47,
    conversionStrictness: 0.42,
    conversionPersona: 'tactical',
    weights: { tactical: 0.97, positional: 0.28, sacrificial: 0.98, prophylactic: 0.16 },
  ...
  vega_italian: {
    ...
    conversionPersona: 'technical',
    weights: { tactical: 0.78, positional: 0.74, sacrificial: 0.52, prophylactic: 0.76 },
    motifBias: { fork: 0.58, pin: 0.86, skewer: 0.74, kingHunt: 0.72 },
  },
}
