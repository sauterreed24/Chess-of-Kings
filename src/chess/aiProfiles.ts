...
export const AI_PROFILES: Record<string, AiProfile> = {
  ...
  counterpart_apex: {
    ...
    motifBias: { fork: 0.68, pin: 1, skewer: 0.99, kingHunt: 0.58 },
  },
  alexion_mentor: {
    id: 'alexion_mentor',
  ...
  alexion_strategos: {
    ...
    conversionPersona: 'technical',
    weights: { tactical: 0.64, positional: 0.93, sacrificial: 0.3, prophylactic: 0.95 },
    motifBias: { fork: 0.54, pin: 0.93, skewer: 0.9, kingHunt: 0.42 },
  },
  alexion_apex: {
    id: 'alexion_apex',
    ...
    conversionPersona: 'technical',
    weights: { tactical: 0.9, positional: 0.99, sacrificial: 0.42, prophylactic: 0.99 },
    motifBias: { fork: 0.68, pin: 1, skewer: 0.99, kingHunt: 0.6 },
  },
  rowan_gambit: {
    id: 'rowan_gambit',
    ...
    openingDiscipline: 0.34,
    kingSafetyUrgency: 0.42,
  ...
  vega_italian: {
    ...
    conversionPersona: 'technical',
    weights: { tactical: 0.78, positional: 0.78, sacrificial: 0.52, prophylactic: 0.82 },
    motifBias: { fork: 0.58, pin: 0.9, skewer: 0.74, kingHunt: 0.72 },
  },
}
