...
export function renderScene(
  ...
  syncPhoneHitTarget(dom.app.querySelector<HTMLElement>('#btn-sfx'), !togglesHidden)
  syncPhoneHitTarget(dom.app.querySelector<HTMLElement>('#btn-move-guard'), !togglesHidden)
